...
// template<typename T>
// T* k_nearests_neighbor(const tree_model<T> *model, const T *x_test, size_t len, size_t k, bool clf);

// template<typename T>
// void find_k_nearests(const tree_model<T> *model, const T *coor, size_t k, size_t *args, T *dists);    
