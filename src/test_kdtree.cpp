...
void generateRandomPointCloud(vector_of_vectors_t& samples, const size_t N,
...
int main(int argc, char* argv[]) {
  ...
  num_results = mat_index.index->knnSearch(&query_pt[0], num_results,
  ...
  const size_t nMatches = mat_index.index->radiusSearch(
